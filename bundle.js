...
var LeftMenu = React.createClass({displayName: "LeftMenu",
    render: function() {
        return (
            React.createElement(Menu, {showDividers: true, position: "left", autoClose: true}, 
                React.createElement(Brand, null, React.createElement("a", {href: "#"}, "Left menu")), 
                React.createElement(Item, null, React.createElement("a", {href: "#installation"}, "Installation")), 
                React.createElement(Item, null, React.createElement("a", {href: "#how-to-use"}, "How to use")), 
...
var RightMenu = React.createClass({displayName: "RightMenu",
    ...
    render: function() {
        return (
            React.createElement(Menu, {showDividers: false, position: "right"}, 
                React.createElement(Brand, null, React.createElement("a", {href: "#"}, "Right menu")), 
                React.createElement(Item, {onClick: this.handleClick.bind(null, 1)}, "Installation"), 
                React.createElement(Item, {onClick: this.handleClick.bind(null, 2)}, "How to use"), 
...
},{"../modules/impromptu-sidemenu.jsx":2,"react":157}],2:[function(require,module,exports){
var React = require('react');
    ...
    render: function() {
        return (
            React.createElement("div", null, 
                React.createElement("a", {style: this.buttonStyles(), onClick: this.toggle, className: "button-open toggle impromptu-toggle-open"}, 
                    React.createElement("i", {className: "fa fa-bars"})
                ), 
                React.createElement("nav", {style: this.wrapperStyles(), className: "impromptu-menu-wrapper"}, 
                    React.createElement("ul", {className: 'sidebar-nav' + (this.props.showDividers ? ' impromptu-divider' : ''), style: {width: this.props.width || 250}}, 
                        React.createElement("a", {onClick: this.toggle, className: "button-close pull-right toggle"}, 
                        ...
                        React.Children.map(this.props.children, function(item) {
                            ...
                            if (item.type === Brand) {
                                return (
                                    React.createElement("li", {onClick: onClick.bind(this), className: "sidebar-brand"}, 
                                        React.createElement("span", null, item.props.children)
                                    )
                                );
                            } else if (item.type === Item) {
                                return (
                                    React.createElement("li", {onClick: onClick.bind(this)}, 
                                        React.createElement("span", null, item.props.children)
                                    )
                                );
                            } else {
